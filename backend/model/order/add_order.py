    ...
    def api_order_post():
        ...
        try:
            ...
            def insert_order_into_database():
                insert_query = (
                    """INSERT INTO orders(order_prime_number, order_price, order_contact_phone,
            ...
            # Get the order number and other necessary information from the database.
            ...
            # Save all relevant credit card transaction records into the database for record purpose right after fetching the TapPay API.
